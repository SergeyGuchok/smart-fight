...
constructor() {
    this.countries = ['Afghanistan', 'Australia', 'Belarus', 'Russia', 'Poland', 'France', 'Great Britan', 'Georgia', 'Germany', 'India', 'Austria', 'Bulgaria', 'Ukrain', 'China'];
    this.capitals = ['Kabul', 'Canberra', 'Minsk', 'Moscow', 'Warsaw', 'Paris', 'London', 'Tbilisi', 'Berlin', 'New Delhi', 'Vienna', 'Sofia', 'Kyiv', 'Beijing'];
    this.country = null;
    this.answer = null;
  }
